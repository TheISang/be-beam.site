...
>(({ className, iconClassName, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-12 cursor-pointer items-center justify-between rounded-lg border border-gray-500 bg-white px-3 py-2 text-t4 text-sm text-gray-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >
